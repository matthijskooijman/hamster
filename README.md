...
```bash
sudo apt install gettext intltool python3-gi python3-cairo python3-distutils python3-dbus python3-xdg libglib2.0-dev gir1.2-gtk-3.0 gtk-update-icon-cache
